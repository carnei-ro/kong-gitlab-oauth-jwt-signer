...
summary: generate JWT when a gitlab oauth flow is valid  
...
---
plugins:
- name: kong-gitlab-oauth-jwt-signer
  config:
    client_id: <empty> # or env var KONG_GITLAB_OAUTH_JWT_SIGNER_CLIENT_ID
    client_secret: <empty> # or env var KONG_GITLAB_OAUTH_JWT_SIGNER_CLIENT_SECRET
    private_keys: <empty> # private_keys or env var KONG_GITLAB_OAUTH_JWT_SIGNER_PRIVATE_KEYS
    # private_keys:
...
- hosts:
  ...
  - config:
      ...
      gitlab_url: https://gitlab.carnei.ro
    name: kong-gitlab-oauth-jwt-signer
  preserve_host: false
  regex_priority: 1
...
Edit `kong.conf` to permit expose environment variable `KONG_GITLAB_OAUTH_JWT_SIGNER_PRIVATE_KEYS` to kong:
```conf
nginx_main_env=KONG_GITLAB_OAUTH_JWT_SIGNER_PRIVATE_KEYS
```
...
Create the environment variable `KONG_GITLAB_OAUTH_JWT_SIGNER_PRIVATE_KEYS` that is a JSON.
Format:  
- key = `kid` of the JWT 
...
Example:
`KONG_GITLAB_OAUTH_JWT_SIGNER_PRIVATE_KEYS`
```json
{
  "12345678-1234-1234-1234-123456789ABC":""
}
